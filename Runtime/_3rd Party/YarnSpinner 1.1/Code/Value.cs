...
namespace Yarn
{
    ...
    public class Value : IComparable, IComparable<Value> {
		...
		public void SetType(string typeString){
			Type oldType = type;
			if (string.Equals (typeString, Value.Type.Bool.ToString ())) {
				type = Value.Type.Bool;
			}

			else if (string.Equals (typeString, Value.Type.Number.ToString ())) {
				type = Value.Type.Number;
			}
			else if (string.Equals (typeString, Value.Type.String.ToString ())) {
				type = Value.Type.String;
			}
			else if (string.Equals (typeString, Value.Type.Variable.ToString ())) {
		...
		public void SetValue(string newval){
			...
			case Type.Number:
				try{
					numberValue = float.Parse (newval);
			...
			case Type.String:
				...
				return;
			case Type.Bool:
				if (string.Equals (newval, "True") | string.Equals (newval, "true") | string.Equals (newval, "TRUE")) {
					boolValue = true;
				} else {
					boolValue = false;
				}
		...
		public void SetValue(float newval){
			...
			case Type.Number:
				...
				return;
			case Type.Variable:
				variableName = newval.ToString ();
				return;
			case Type.String:
				stringValue = newval.ToString ();
				return;
			case Type.Bool:
				if (newval > 0) {
					boolValue = true;
