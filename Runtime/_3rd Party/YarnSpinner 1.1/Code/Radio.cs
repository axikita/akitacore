...
public class Radio : MonoBehaviour {
	...
	void Start () {
		AudioFile file = FileByName (songs, songOnAwake);
		if (file != null) {
	...
	public void PlaySong(string title){
		AudioFile file = FileByName (songs, title);
		if (file == null) {
	...
	public void PlaySound(string title){
		AudioFile file = FileByName (foley, title);
		if (file == null) {
	...
	AudioFile FileByName(AudioFile[] library, string name){
